...
#include "Widgets/Weapons/Slate/SCircumferenceMarkerWidget.h"
...
SCircumferenceMarkerWidget::SCircumferenceMarkerWidget()
	: MarkerBrush(nullptr)
	, bColorAndOpacitySet(false)
	, bReticleCornerOutsideSpreadRadius(0)
{
}
...
void SCircumferenceMarkerWidget::SetMarkerList(const TArray<FCircumferenceMarkerEntry>& NewMarkerList)
{
