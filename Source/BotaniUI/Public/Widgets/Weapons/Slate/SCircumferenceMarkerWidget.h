 ...
 *
 * A single entry in the circumference marker widget
 */
...
class BOTANIUI_API SCircumferenceMarkerWidget : public SCompoundWidget
{
public:
...
public:
	...
	void SetMarkerList(const TArray<FCircumferenceMarkerEntry>& NewMarkerList);
