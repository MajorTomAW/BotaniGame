...
#include "ApplicationMode_Item.h"
...
FApplicationMode_Item::FApplicationMode_Item(TSharedPtr<FItemEditorApp> App)
	: FApplicationMode(ItemEditorIDs::Modes::ItemMode)
	, AppPtr(App)
{
	...
	TabLayout = FTabManager::NewLayout("Standalone_ItemEditor_Layout_v1")
	->AddArea
	(
...
void FApplicationMode_Item::RegisterTabFactories(TSharedPtr<FTabManager> InTabManager)
{
...
void FApplicationMode_Item::PreDeactivateMode()
{
	FApplicationMode::PreDeactivateMode();
}

void FApplicationMode_Item::PostActivateMode()
{
