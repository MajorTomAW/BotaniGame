...
class UEnhancedOnlineRequest_FindFriendSession;
...
#pragma region online_identity
	 ...
	 * @param bAllowCommandLineAuth	Whether to allow command line authentication.
	 */
	UFUNCTION(BlueprintCallable, Category = "Online|EnhancedSessions|Identity")
	virtual void LoginOnlineUser(UEnhancedOnlineRequest_LoginUser* Request, bool bAllowCommandLineAuth = true);
...
protected:
	...
	/** Online Identity */
	virtual void LoginOnlineUserInternal(ULocalPlayer* LocalPlayer, UEnhancedOnlineRequest_LoginUser* Request, bool bAllowCommandLineAuth = true);
