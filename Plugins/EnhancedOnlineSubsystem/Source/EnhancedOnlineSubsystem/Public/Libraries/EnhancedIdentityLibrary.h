...
public:
	...
	/**
	 * Get the player name
	 * @param InPlayerState player to get the name of
	 * @return the player name
	 */
	UFUNCTION(BlueprintCallable, BlueprintPure, Category = "Online|EnhancedSessions|Management|Identity", meta = (DisplayName = "Get Player Nickname"))
	static FString K2_GetPlayerName(APlayerState* InPlayerState);

	UFUNCTION(BlueprintCallable, BlueprintPure, Category = "Online|EnhancedSessions|Management|Identity", meta = (DisplayName = "Get Player Id String"))
	static FString K2_GetPlayerIdString(APlayerState* InPlayerState);
