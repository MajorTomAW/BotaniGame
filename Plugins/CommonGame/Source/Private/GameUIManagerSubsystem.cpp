...
void UGameUIManagerSubsystem::Initialize(FSubsystemCollectionBase& Collection)
{
	...
	{
		UE_LOG(LogCommonGame, Warning, TEXT("No default policy class specified! \n CurrentPolicy: %s\n DefaultPolicy: %s"), *GetPathNameSafe(CurrentPolicy), *DefaultUIPolicyClass.ToSoftObjectPath().ToString());
	}
}
