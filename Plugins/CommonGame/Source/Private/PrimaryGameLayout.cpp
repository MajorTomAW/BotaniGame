...
UE_DEFINE_GAMEPLAY_TAG_STATIC(TAG_Layer_Game, "UI.Layer.Game");
UE_DEFINE_GAMEPLAY_TAG_STATIC(TAG_Layer_Menu, "UI.Layer.Menu");
UE_DEFINE_GAMEPLAY_TAG_STATIC(TAG_Layer_Modal, "UI.Layer.Modal");
UE_DEFINE_GAMEPLAY_TAG_STATIC(TAG_Layer_Settings, "UI.Layer.Settings");
UE_DEFINE_GAMEPLAY_TAG_STATIC(TAG_Layer_Notification, "UI.Layer.Notification");
